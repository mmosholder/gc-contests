...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-abac5d4c", Component.options)
  } else {
    hotAPI.reload("data-v-abac5d4c", Component.options)
  }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Interface_vue__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Interface_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__components_Interface_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: "app",
  components: {
    Interface: __WEBPACK_IMPORTED_MODULE_0__components_Interface_vue___default.a
  }
});
...
Component.options.__file = "src/components/Interface.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2d530e52", Component.options)
  } else {
    hotAPI.reload("data-v-2d530e52", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__vendor_moment_min_js__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__vendor_moment_min_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__vendor_moment_min_js__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	data: function data() {
		...
		return _ref = {
			...
			// userId: 1,
			userEntries: null
		}, _defineProperty(_ref, 'editingEntry', null), _defineProperty(_ref, 'updatedTier1', []), _defineProperty(_ref, 'updatedTier2', []), _defineProperty(_ref, 'updatedTier3', []), _defineProperty(_ref, 'updatedTier4', []), _defineProperty(_ref, 'updatedTier5', []), _defineProperty(_ref, 'updatedTier6', []), _defineProperty(_ref, 'contests', [{
			name: 'The Players Championship',
			starts: __WEBPACK_IMPORTED_MODULE_1__vendor_moment_min_js___default()('2018/05/09 07:00').utc().format(),
			id: 2
		}, {
			name: 'The US Open',
			starts: __WEBPACK_IMPORTED_MODULE_1__vendor_moment_min_js___default()('2018/06/14').utc().format(),
			id: 3
		}, {
			name: 'The Open',
			starts: '2018/07/19',
			...
			starts: '2018/08/09',
			id: 5
		}]), _defineProperty(_ref, 'currentContest', {
			name: 'The Players Championship',
			starts: '2018/05/09',
			id: 2
		}), _ref;
	...
	computed: {
		filteredTier6: function filteredTier6() {
			var tier6 = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.concat(this.golfers.tier1, this.golfers.tier2, this.golfers.tier3, this.golfers.tier4, this.golfers.tier5);
			return __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.pull(tier6, this.editingEntry.tier1, this.editingEntry.tier2, this.editingEntry.tier3, this.editingEntry.tier4, this.editingEntry.tier5);
		},
		filteredContest: function filteredContest() {
	...
	methods: {
		getUserEntries: function getUserEntries() {
			var _this = this;

			// if (this.userId.length) {
			axios.get('http://l95.91e.myftpupload.com/wp-json/contests/v1/users/' + this.userId).then(function (r) {
				_this.userEntries = r.data;
			});
			// }
		},
		...
		getGolfersTest: function getGolfersTest() {
			var _this2 = this;

			axios.get('http://l95.91e.myftpupload.com/wp-json/acf/v3/pages/2399').then(function (r) {

				var arr1 = r.data.acf.tier1.split(',');
				var arr2 = r.data.acf.tier2.split(',');
				var arr3 = r.data.acf.tier3.split(',');
				var arr4 = r.data.acf.tier4.split(',');
				var arr5 = r.data.acf.tier5.split(',');

				_this2.$set(_this2.golfers, 'tier1', arr1);
				_this2.$set(_this2.golfers, 'tier2', arr2);
				_this2.$set(_this2.golfers, 'tier3', arr3);
				_this2.$set(_this2.golfers, 'tier4', arr4);
				_this2.$set(_this2.golfers, 'tier5', arr5);
			});
		},
		addGolfer: function addGolfer(golfer, tier, i) {
		...
		removePick: function removePick(tier, pick) {
		...
		submitEntry: function submitEntry() {
			...
			axios.patch('http://l95.91e.myftpupload.com/wp-json/contests/v1/contest/' + this.currentContest.id + '/entries/' + this.editingEntry.entry_id, entryInfo).then(function (r) {
				_this3.editingEntry = null;
				_this3.getUserEntries();
			});
		}
	}
});
...
!function (e, t) {
  ...
  function At(e, t) {
    var n,
        ...
        r = e,
        a = null;
    return Rt(e) ? r = { ms: e._milliseconds, d: e._days, M: e._months } : d(e) ? (r = {}, t ? r[t] = e : r.milliseconds = e) : (a = Et.exec(e)) ? (n = "-" === a[1] ? -1 : 1, r = {
      y: 0,
      d: k(a[ye]) * n,
      h: k(a[ge]) * n,
      m: k(a[pe]) * n,
      ...
      m: jt(a[7], n),
      s: jt(a[8], n)
    }) : null == r ? r = {} : "object" == (typeof r === "undefined" ? "undefined" : _typeof(r)) && ("from" in r || "to" in r) && (i = function (e, t) {
      var n;
...
var render = function() {
  ...
  return _c("div", [
    _c("section", { staticClass: "gc-tabs-user-entries" }, [
      _vm.userEntries && _vm.userEntries.length > 0
        ? _c("div", [
            _c("p", [
              _vm._v(
                "Choose an entry to edit or submit for " +
                  _vm._s(_vm.currentContest.name)
              )
            ]),
            _vm._v(" "),
            _c(
              "select",
              {
                ...
                on: {
                  change: function($event) {
                    ...
                    _vm.selectedEntry = $event.target.multiple
                      ? $$selectedVal
                      : $$selectedVal[0]
                  }
                }
              },
              _vm._l(_vm.userEntries, function(entry) {
                return entry.contest_id == _vm.currentContest.id
                  ? _c(
                      "option",
                      { key: entry.id, domProps: { value: entry } },
      ...
      _vm.userEntries && _vm.userEntries.length == 0
        ? _c("div", [
            _vm._v(
              "Sorry, registration for this contest is closed! Check back next year"
            )
          ])
        : _vm._e()
    ]),
    _vm._v(" "),
    _vm.editingEntry
      ? _c("section", { staticClass: "gc-tabs" }, [
          _c("div", { staticClass: "gc-tabs-content" }, [
            _c("ul", { staticClass: "gc-tabs-links" }, [
              _c(
                "li",
                {
                  class: _vm.activeTier == "tier1" ? "-active" : "",
                  on: {
                    click: function($event) {
                      _vm.activeTier = "tier1"
                    }
                  }
                },
                [_c("span", [_vm._v("Tier 1")])]
              ),
              _vm._v(" "),
              _c(
                "li",
                {
                  class: _vm.activeTier == "tier2" ? "-active" : "",
                  on: {
                    click: function($event) {
                      _vm.activeTier = "tier2"
                    }
                  }
                },
                [_c("span", [_vm._v("Tier 2")])]
              ),
              _vm._v(" "),
              _c(
                "li",
                {
                  class: _vm.activeTier == "tier3" ? "-active" : "",
                  on: {
                    click: function($event) {
                      _vm.activeTier = "tier3"
                    }
                  }
                },
                [_c("span", [_vm._v("Tier 3")])]
              ),
              _vm._v(" "),
              _c(
                "li",
                {
                  class: _vm.activeTier == "tier4" ? "-active" : "",
                  on: {
                    click: function($event) {
                      _vm.activeTier = "tier4"
                    }
                  }
                },
                [_c("span", [_vm._v("Tier 4")])]
              ),
              _vm._v(" "),
              _c(
                "li",
                {
                  class: _vm.activeTier == "tier5" ? "-active" : "",
                  on: {
                    click: function($event) {
                      _vm.activeTier = "tier5"
                    }
                  }
                },
                [_c("span", [_vm._v("Tier 5")])]
              ),
              _vm._v(" "),
              _c(
                "li",
                {
                  class: _vm.activeTier == "tier6" ? "-active" : "",
                  on: {
                    click: function($event) {
                      _vm.activeTier = "tier6"
                    }
                  }
                },
                [_c("span", [_vm._v("Tier 6")])]
              )
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "gc-tabs-tiers" }, [
              _vm.activeTier == "tier1"
                ? _c("section", [
                    _c(
                      "ul",
                      { staticClass: "gc-tabs-golfers" },
                      _vm._l(_vm.golfers.tier1, function(golfer, i) {
                        return _c("li", { key: i }, [
                          golfer != _vm.editingEntry.tier1 &&
                          golfer != _vm.editingEntry.tier6
                            ? _c(
                                "p",
                                {
                                  on: {
                                    click: function($event) {
                                      _vm.addGolfer(golfer, 1, i)
                                    }
                                  }
                                },
                                [_vm._v(_vm._s(golfer))]
                              )
                            : _c("p", { staticClass: "-null" }, [
                                _vm._v(_vm._s(golfer))
                              ])
                        ])
                      })
              ...
              _vm.activeTier == "tier2"
                ? _c("section", [
                    _c(
                      "ul",
                      { staticClass: "gc-tabs-golfers" },
                      _vm._l(_vm.golfers.tier2, function(golfer, i) {
                        return _c("li", { key: i }, [
                          golfer != _vm.editingEntry.tier2 &&
                          golfer != _vm.editingEntry.tier6
                            ? _c(
                                "p",
                                {
              ...
              _vm.activeTier == "tier3"
                ? _c("section", [
                    _c(
                      "ul",
                      { staticClass: "gc-tabs-golfers" },
                      _vm._l(_vm.golfers.tier3, function(golfer, i) {
                        return _c("li", { key: i }, [
                          golfer != _vm.editingEntry.tier3 &&
                          golfer != _vm.editingEntry.tier6
                            ? _c(
                                "p",
                                {
              ...
              _vm.activeTier == "tier4"
                ? _c("section", [
                    _c(
                      "ul",
                      { staticClass: "gc-tabs-golfers" },
                      _vm._l(_vm.golfers.tier4, function(golfer, i) {
                        return _c("li", { key: i }, [
                          golfer != _vm.editingEntry.tier4 &&
                          golfer != _vm.editingEntry.tier6
                            ? _c(
                                "p",
                                {
              ...
              _vm.activeTier == "tier5"
                ? _c("section", [
                    _c(
                      "ul",
                      { staticClass: "gc-tabs-golfers" },
                      _vm._l(_vm.golfers.tier5, function(golfer, i) {
                        return _c("li", { key: i }, [
                          golfer != _vm.editingEntry.tier5 &&
                          golfer != _vm.editingEntry.tier6
                            ? _c(
                                "p",
                                {
              ...
              _vm.activeTier == "tier6"
                ? _c(
                    "section",
                    _vm._l(_vm.filteredTier6, function(golfer, i) {
                      return _c(
                        "ul",
                        { key: i, staticClass: "gc-tabs-golfers" },
                        [
                          _c("li", [
                            golfer != _vm.editingEntry.tier6 &&
                            golfer != _vm.editingEntry.tier6
          ...
          _vm._v(" "),
          _c("div", { staticClass: "gc-tabs-picks" }, [
            _c("p", { staticClass: "gc-tabs-picks-title" }, [
              _vm._v("Your Picks")
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "gc-tabs-picks-list" }, [
              _c("div", { staticClass: "gc-tabs-picks-item" }, [
                _c("p", [
                  _c("strong", [_vm._v("Tier 1:")]),
                  _vm._v(" " + _vm._s(_vm.editingEntry.tier1))
                ]),
                _vm._v(" "),
                _vm.editingEntry.tier1
                  ? _c(
                      "span",
                      {
                        on: {
                          click: function($event) {
                            _vm.removePick(1, _vm.editingEntry.tier1)
                          }
                        }
                      },
                      [_vm._v("Remove")]
              ...
              _c("div", { staticClass: "gc-tabs-picks-item" }, [
                _c("p", [
                  _c("strong", [_vm._v("Tier 2:")]),
                  _vm._v(" " + _vm._s(_vm.editingEntry.tier2))
                ]),
                _vm._v(" "),
                _vm.editingEntry.tier2
                  ? _c(
                      "span",
                      {
                        on: {
                          click: function($event) {
                            _vm.removePick(2, _vm.editingEntry.tier2)
                          }
                        }
                      },
                      [_vm._v("Remove")]
              ...
              _c("div", { staticClass: "gc-tabs-picks-item" }, [
                _c("p", [
                  _c("strong", [_vm._v("Tier 3:")]),
                  _vm._v(" " + _vm._s(_vm.editingEntry.tier3))
                ]),
                _vm._v(" "),
                _vm.editingEntry.tier3
                  ? _c(
                      "span",
                      {
                        on: {
                          click: function($event) {
                            _vm.removePick(3, _vm.editingEntry.tier3)
                          }
                        }
                      },
                      [_vm._v("Remove")]
              ...
              _c("div", { staticClass: "gc-tabs-picks-item" }, [
                _c("p", [
                  _c("strong", [_vm._v("Tier 4:")]),
                  _vm._v(" " + _vm._s(_vm.editingEntry.tier4))
                ]),
                _vm._v(" "),
                _vm.editingEntry.tier4
                  ? _c(
                      "span",
                      {
                        on: {
                          click: function($event) {
                            _vm.removePick(4, _vm.editingEntry.tier4)
                          }
                        }
                      },
                      [_vm._v("Remove")]
              ...
              _c("div", { staticClass: "gc-tabs-picks-item" }, [
                _c("p", [
                  _c("strong", [_vm._v("Tier 5:")]),
                  _vm._v(" " + _vm._s(_vm.editingEntry.tier5))
                ]),
                _vm._v(" "),
                _vm.editingEntry.tier5
                  ? _c(
                      "span",
                      {
                        on: {
                          click: function($event) {
                            _vm.removePick(5, _vm.editingEntry.tier5)
                          }
                        }
                      },
                      [_vm._v("Remove")]
              ...
              _c("div", { staticClass: "gc-tabs-picks-item" }, [
                _c("p", [
                  _c("strong", [_vm._v("Tier 6:")]),
                  _vm._v(" " + _vm._s(_vm.editingEntry.tier6))
                ]),
                _vm._v(" "),
                _vm.editingEntry.tier6
                  ? _c(
                      "span",
                      {
                        on: {
                          click: function($event) {
                            _vm.removePick(6, _vm.editingEntry.tier6)
                          }
                        }
                      },
                      [_vm._v("Remove")]
    ...
    _vm._v(" "),
    _vm.editingEntry &&
    (_vm.editingEntry.tier1.length &&
      _vm.editingEntry.tier2.length &&
      _vm.editingEntry.tier3.length &&
      _vm.editingEntry.tier4.length &&
      _vm.editingEntry.tier5.length &&
      _vm.editingEntry.tier6.length)
      ? _c(
          "div",
          {
            staticClass: "gc-tabs-submit",
            on: {
              click: function($event) {
                _vm.submitEntry()
              }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-2d530e52", module.exports)
  }
}
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { attrs: { id: "app" } }, [_c("Interface")], 1)
}
var staticRenderFns = []
render._withStripped = true
module.exports = { render: render, staticRenderFns: staticRenderFns }
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-abac5d4c", module.exports)
  }
}
