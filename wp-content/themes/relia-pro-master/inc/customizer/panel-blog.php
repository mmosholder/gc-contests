...
// ---------------------------------------------
    ...
    // Blog Template Background Style
    $wp_customize->add_setting( 'relia_blog_bg_style', array (
        'default'               => 'dark',
        'transport'             => 'refresh',
        'sanitize_callback'     => 'relia_sanitize_blog_bg'
    ) );
    $wp_customize->add_control( 'relia_blog_bg_style', array(
        'label'                 => __( 'Blog Template Background Color', 'relia' ),
        'section'               => 'relia_blog_layout_section',
        'type'                  => 'radio',
        'choices'   => array(
            'dark'          => __( 'Dark / Default', 'relia' ),
            'light'         => __( 'Light', 'relia' ),
        )
    ));
