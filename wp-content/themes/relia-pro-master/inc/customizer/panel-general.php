...
// WooCommerce Section
// ---------------------------------------------
$wp_customize->add_section( 'relia_commerce_section', array(
    'title'                 => __( 'WooCommerce', 'relia'),
    'description'           => __( 'Customize settings relating to the WooCommerce plugin', 'relia' ),
    'panel'                 => 'relia_general_panel'
) );

// ---------------------------------------------
// WooCommerce Section - Settings & Controls
// ---------------------------------------------

    // Shop Sidebar Location
    $wp_customize->add_setting( 'relia_shop_sidebar_location', array (
        'default'               => 'right',
        'transport'             => 'postMessage',
        'sanitize_callback'     => 'relia_sanitize_shop_sidebar',
    ) );
    $wp_customize->add_control( 'relia_shop_sidebar_location', array(
        'type'                  => 'radio',
        'section'               => 'relia_commerce_section',
        'label'                 => __( 'Shop Sidebar Location', 'relia' ),
        'description'           => __( 'If your Shop sidebar has widgets inside, this setting determines where that sidebar appears', 'relia' ),
        'choices'               => array(
