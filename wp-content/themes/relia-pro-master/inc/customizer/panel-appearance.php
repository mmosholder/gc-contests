...
// ---------------------------------------------
    ...
    $wp_customize->add_setting('relia_color_skin_toggle', array(
        'default'               => 'preset',
        'transport'             => 'refresh',
        'sanitize_callback'     => 'relia_sanitize_text'
    ));
    $wp_customize->add_control('relia_color_skin_toggle', array(
        'type'                  => 'radio',
        'section'               => 'relia_color_section',
        'label'                 => __('Use Custom Color or a Preset?', 'relia'),
        'description'           => __('Select whether to use the selected preset or a custom value from the picker', 'relia'),
        'choices'   => array(
            'preset'       => __('Preset', 'relia'),
            'custom'       => __('Custom Color', 'relia'),
        )
    ));

    // Custom Color
    $wp_customize->add_setting( 'relia_theme_color', array (
        'default'               => '#ca6',
        'transport'             => 'refresh',
    ...
    $wp_customize->add_control( 
        ...
        'relia_theme_color', 
        array(
                'label'         => __( 'Custom Theme Color', 'relia' ),
                'section'       => 'relia_color_section',
                'settings'      => 'relia_theme_color',
        ) ) 
    );
